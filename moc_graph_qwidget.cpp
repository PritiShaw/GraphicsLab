...
#include <memory>
#include "../build-76/graph_qwidget.h"
...
QT_MOC_LITERAL(1, 14, 13), // "Mouse_Pressed"
QT_MOC_LITERAL(2, 28, 0), // ""
QT_MOC_LITERAL(3, 29, 9), // "Mouse_Pos"
QT_MOC_LITERAL(4, 39, 10) // "Mouse_Left"
...
void graph_qWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<graph_qWidget *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            using _t = void (graph_qWidget::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&graph_qWidget::Mouse_Pressed)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (graph_qWidget::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&graph_qWidget::Mouse_Pos)) {
                *result = 1;
                return;
            }
        }
        {
            using _t = void (graph_qWidget::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&graph_qWidget::Mouse_Left)) {
                *result = 2;
                return;
            }
        }
